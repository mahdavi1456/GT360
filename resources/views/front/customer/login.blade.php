            ...
            <div class="d-flex flex-column checkout-box-login">
                ...
                <form method="POST" action="{{ route('confirmLogin') }}" id="codeform" style="display: none;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <button type="button" class="btn btn-secondary btn-block" style="width: 100%;" id="resend-code">ارسال مجدد کد</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script>
        ...
        function updateCountdown() {
            ...
            if (countdownSeconds === 0) {
                ...
                document.getElementById('countdown').innerHTML = "در صورت عدم دریافت پیامک، روی دکمه ارسال مجدد کلیک کنید.";
