    ...
    <div class="container-fuild">
        <div class="row">
            <div id="rev_slider_4_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container"
                 ...
                 style="margin:0px auto;background-color:transparent;padding:0px;margin-top:0px;margin-bottom:0px;direction: ltr">
                    ...
                    <ul>
                        <li data-index="rs-1812" data-transition="zoomin" data-slotamount="7"
                            ...
                            <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                                 ...
                                 style="z-index: 6; white-space: nowrap;">خدمات کامپیوتری
                            </div>
                            <!-- LAYER NR. 3 -->
                        ...
                        <li data-index="rs-181" data-transition="zoomin" data-slotamount="7"
                            ...
                            <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                                 ...
                                 data-responsive_offset="on"
                                 data-elementdelay="0.05"
                                 style="z-index: 6; white-space: nowrap;">سریع و مقرون به صرفه
                            </div>
                            <!-- LAYER NR. 3 -->
                        </li>
                        <li data-index="rs-18" data-transition="zoomin" data-slotamount="7"
                            ...
                            <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                                 ...
                                 data-responsive_offset="on"
                                 data-elementdelay="0.05"
                                 style="z-index: 6; white-space: nowrap;">ما آن را برطرف می کنیم
                            </div>
                            <!-- LAYER NR. 3 -->
            ...
            <div class="col-md-12">
                <div class="full">
                    <div class="main_heading text_align_center">
                        ...
                        <p class="large">سریعترین خدمات تعمیر با بهترین قیمت!</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="full text_align_center margin_bottom_30">
                    ...
                    <h4 class="theme_color">بازیابی اطلاعات</h4>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="full text_align_center margin_bottom_30">
                    ...
                    <h4 class="theme_color">تعمیر رایانه</h4>
                    <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="full text_align_center margin_bottom_30">
                    ...
                    <h4 class="theme_color">سرویس موبایل</h4>
                    <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="full text_align_center margin_bottom_30 margin_0">
                    ...
                    <h4 class="theme_color">راه حل های شبکه</h4>
                    <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ</p>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="panel-heading">
                                        <p class="panel-title"><a data-toggle="collapse" data-parent="#accordion"
                                                                  href="#collapseOne"><i class="fa fa-bar-chart"
                                                                                         aria-hidden="true"></i> بازیابی
                                            کامل از درایو محلی و خارجی<i class="fa fa-angle-down"></i></a></p>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <p class="panel-title"><a data-toggle="collapse" data-parent="#accordion"
                                            ...
                                            بازیابی عکس ، تصویر ، ویدئو و صدا<i class="fa fa-angle-down"></i></a></p>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <p class="panel-title"><a data-toggle="collapse" data-parent="#accordion"
                                            ...
                                            بازیابی تلفن همراه<i class="fa fa-angle-down"></i></a></p>
                                    </div>
                                    ...
                                    <div class="panel-heading">
                                        <p class="panel-title"><a data-toggle="collapse" data-parent="#accordion"
                                                                  href="#collapseFour"><i class="fa fa-bar-chart"
                                                                                          aria-hidden="true"></i>
                                            بازیابی کامل از درایو محلی و خارجی<i class="fa fa-angle-down"></i></a></p>
                                    </div>
            ...
            <div class="col-md-12">
                <div class="full">
                    <div class="main_heading text_align_left">
                        <h2>فرایند خدمات</h2>
                        <p class="large">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="full">
                    <div class="main_heading text_align_center">
                        <h2>محصولات ما</h2>
                        <p class="large">ما محصولات خود را با بهترین خدمات بسته بندی می کنیم تا شما را به یک مشتری راضی
                            تبدیل کنیم.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin_bottom_50">
                        ...
                        <div class="text_align_right">
                            <p class="counter-heading text_align_right">مشتریان خوشحال</p>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin_bottom_50">
                        ...
                        <div class="text_align_right">
                            <p class="counter-heading text_align_right">تعمیر لپ تاپ </p>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin_bottom_50">
                        ...
                        <div class="text_align_right">
                            <p class="counter-heading">تعمیر کامپیوتر</p>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin_bottom_50">
                        ...
                        <div class="text_align_right">
                            <p class="counter-heading">سیستم عامل نصب شده است</p>
                        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="full">
                    <div class="main_heading text_align_left">
                        <h2>جدیدترین مطالب از وبلاگ ما</h2>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="full blog_colum">
                    ...
                    <div class="post_time">
                        <p><i class="fa fa-clock-o"></i> 16 آوریل 2018 (در حال نگهداری)</p>
                    </div>
                    <div class="blog_feature_head">
                        <h4>چرا رایانه شما از شما متنفر است</h4>
                    </div>
            ...
            <div class="col-md-4">
                <div class="full blog_colum">
                    ...
                    <div class="blog_feature_head">
                        <h4>نکات ساده در تعمیر کامپیوتر</h4>
                    </div>
                    <div class="blog_feature_cont">
                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.
                            چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است...</p>
            ...
            <div class="col-md-4">
                <div class="full blog_colum">
                    ...
                    <div class="blog_feature_head">
                        <h4>تعمیر و نگهداری کامپیوتر 2018</h4>
                    </div>
                    <div class="blog_feature_cont">
                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.
                            چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است...</p>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 offset-lg-2 offset-md-2 offset-sm-2 col-xs-10 col-xs-offset-1">
                        <div class="navbar-search">
                            <form action="#" method="get" id="search-global-form" class="search-global">
                                ...
                                <div class="search-global__note">جستجوی خود را در بالا تایپ کنید و بازگشت را برای جستجو
                                    فشار دهید.
                                </div>
                            </form>
                        </div>
