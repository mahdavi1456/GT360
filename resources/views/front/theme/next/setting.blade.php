            ...
            <div class="row">
                <div class="col-4 form-group">
                    ...
                    <input name="section1_title" class="form-control" placeholder="عنوان بخش اول..."
                        value="{{ $settingModel->getSetting('section1_title', $accountId, $projectId) }}">
                </div>
                <div class="col-4 form-group">
                ...
                <div class="col-4 form-group">
                    ...
                    <input name="section1_component" class="form-control" placeholder="لیست محتوا بخش اول..."
                        value="{{ $settingModel->getSetting('section1_component', $accountId, $projectId) }}">
                </div>
            </div>
        </div>
    @endif
            ...
            <div class="row">
                <div class="col-6 form-group">
                    ...
                    <input name="section2_title" class="form-control" placeholder="عنوان بخش دوم..."
                        value="{{ $settingModel->getSetting('section2_title', $accountId, $projectId) }}">
                </div>
                <div class="col-6 form-group">
                    ...
                    <input name="section2_component" class="form-control" placeholder="لیست محتوا بخش دوم..."
                        value="{{ $settingModel->getSetting('section2_component', $accountId, $projectId) }}">
                </div>
            </div>
        </div>
    @endif
            ...
            <div class="row">
                <div class="col-6 form-group">
                    ...
                    <input name="section3_title" class="form-control" placeholder="عنوان بخش سوم..."
                        value="{{ $settingModel->getSetting('section3_title', $accountId, $projectId) }}">
                </div>
                <div class="col-6 form-group">
                    ...
                    <input name="section3_component" class="form-control" placeholder="لیست محتوا بخش سوم..."
                        value="{{ $settingModel->getSetting('section3_component', $accountId, $projectId) }}">
                </div>
            </div>
        </div>
    @endif
            ...
            <div class="row">
                <div class="col-6 form-group">
                    ...
                    <input name="section4_title" class="form-control" placeholder="عنوان بخش چهارم..."
                        value="{{ $settingModel->getSetting('section4_title', $accountId, $projectId) }}">
                </div>
                <div class="col-6 form-group">
                    ...
                    <input name="section4_component" class="form-control" placeholder="لیست محتوا بخش چهارم..."
                        value="{{ $settingModel->getSetting('section4_component', $accountId, $projectId) }}">
                </div>
            </div>
        </div>
    @endif
            ...
            <div class="row">
                <div class="col-6 form-group">
                    ...
                    <input name="section5_title" class="form-control" placeholder="عنوان بخش پنجم..."
                        value="{{ $settingModel->getSetting('section5_title', $accountId, $projectId) }}">
                </div>
                <div class="col-6 form-group">
                    ...
                    <input name="section5_component" class="form-control" placeholder="لیست محتوا بخش پنجم..."
                        value="{{ $settingModel->getSetting('section5_component', $accountId, $projectId) }}">
                </div>
            </div>
        </div>
    @endif
