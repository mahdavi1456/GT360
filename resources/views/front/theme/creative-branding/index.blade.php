...
<head>
    ...
    <title>Onepage - clean responsive HTML5 themes - thomsoon.com</title>
		...
		<link rel="stylesheet" type="text/css" href="{{ asset('front-theme-asset/creative-branding') }}/css/style-responsive.css" />
...
<div class="preloader" id="preloader">
    <div class="item">
      <img src="{{ asset('front-theme-asset/creative-branding') }}/img/loading.gif">
    </div>
</div>
...
<!-- section start-page -->
    ...
    <div class="opacity"></div> <!-- Opacity color -->
      <div class="content">
        <div class="text">
          ...
          <div class="logo"><img src="{{ asset('front-theme-asset/creative-branding') }}/img/logo.png"></div>
  ...
  <section class="menu-media">
    ...
    <div class="menu-content">
      ...
      <div class="icon"><a href="#"><img src="{{ asset('front-theme-asset/creative-branding') }}/img/icons/menu-media.png"/></a></div>
  ...
  <section class="portfolio" id="portfolio">
    ...
    <!-- 1 item portoflio-->
        ...
        <ul class="grid">
          ...
          <li>
            <a href="#">
              <img src="{{ asset('front-theme-asset/creative-branding') }}/img/portfolio/1.png" alt="Portfolio item" />
                <div class="text">
                  <p>PORTFOLIO 1</p>
          ...
          <li>
            <a href="#">
              <img src="{{ asset('front-theme-asset/creative-branding') }}/img/portfolio/2.png" alt="Portfolio item" />
                <div class="no-text">
                  <p></p>
          ...
          <li>
            <a href="#">
              <img src="{{ asset('front-theme-asset/creative-branding') }}/img/portfolio/3.png" alt="Portfolio item" />
                <div class="no-text">
                  <p></p>
                  <p class="description"></p>
              </div>
          ...
          <li>
            <a href="#">
              <img src="{{ asset('front-theme-asset/creative-branding') }}/img/portfolio/4.png" alt="Portfolio item" />
                <div class="no-text">
                  <p></p>
                  <p class="description"></p>
              </div>
          ...
          <li>
            <a href="#">
              <img src="{{ asset('front-theme-asset/creative-branding') }}/img/portfolio/5.png" alt="Portfolio item" />
                <div class="no-text">
                  <p></p>
                  <p class="description"></p>
              </div>
         ...
         <!-- 7 item portoflio-->
          ...
          <li>
            <a href="#">
              <img src="{{ asset('front-theme-asset/creative-branding') }}/img/portfolio/7.png" alt="Portfolio item" />
                <div class="text">
                  <p>PORTFOLIO 7</p>
                  <p class="description">Your text here...</p>
              </div>
          ...
          <li>
            <a href="#">
              <img src="{{ asset('front-theme-asset/creative-branding') }}/img/portfolio/8.png" alt="Portfolio item" />
                <div class="text">
                  <p>PORTFOLIO 8</p>
                  <p class="description">Your text here...</p>
              </div>
          ...
          <li>
            <a href="#">
              <img src="{{ asset('front-theme-asset/creative-branding') }}/img/portfolio/9.png" alt="Portfolio item" />
                <div class="text">
                  <p>PORTFOLIO 9</p>
                  <p class="description">Your text here...</p>
              </div>
          ...
          <li>
            <a href="#">
              <img src="{{ asset('front-theme-asset/creative-branding') }}/img/portfolio/10.png" alt="Portfolio item" />
                <div class="text">
                  <p>PORTFOLIO 11</p>
                  <p class="description">Your text here...</p>
              </div>
          ...
          <li>
            <a href="#">
              <img src="{{ asset('front-theme-asset/creative-branding') }}/img/portfolio/11.png" alt="Portfolio item" />
                <div class="text">
                  <p>PORTFOLIO 11</p>
                  <p class="description">Your text here...</p>
              </div>
   ...
   <div class="clear"></div>
      ...
      <div class="content">
        ...
        <h2>Thanks for partners</h2>
            ...
            <div class="logo">
                ...
                <a href="#"><img src="{{ asset('front-theme-asset/creative-branding') }}/img/logos/alex1.png"></a>
                <a href="#"><img src="{{ asset('front-theme-asset/creative-branding') }}/img/logos/archiq.png"></a>
                <a href="#"><img src="{{ asset('front-theme-asset/creative-branding') }}/img/logos/thomsoon.png"></a>
                <a href="#"><img src="{{ asset('front-theme-asset/creative-branding') }}/img/logos/alex2.png"></a>
    ...
    <section class="footer">
        ...
        <div class="logo"><img src="{{ asset('front-theme-asset/creative-branding') }}/img/logo-footer.png"></div>
   ...
   <script>
	...
	<script src="{{ asset('front-theme-asset/creative-branding') }}/js/jquery.parallax.js"></script> <!-- jQuery Parallax -->
	<script src="{{ asset('front-theme-asset/creative-branding') }}/js/script.js"></script> <!-- All script -->
