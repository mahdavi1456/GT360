...
<head>
    ...
    <link rel="icon" href="{{ asset('front-theme-asset/primex') }}/images/favicon.ico" type="image/x-icon">
    <link rel="stylesheet" href="{{ asset('front-theme-asset/primex') }}/css/grid.css">
    <link rel="stylesheet" href="{{ asset('front-theme-asset/primex') }}/css/style.css">
    <link rel="stylesheet" href="{{ asset('front-theme-asset/primex') }}/css/camera.css"/>
    <link rel="stylesheet" href="{{ asset('front-theme-asset/primex') }}/css/owl.carousel.css"/>
    <script src="{{ asset('front-theme-asset/primex') }}/js/jquery.js"></script>
    <script src="{{ asset('front-theme-asset/primex') }}/js/jquery-migrate-1.2.1.js"></script>
    <script src="{{ asset('front-theme-asset/primex') }}/js/jquery.equalheights.js"></script>
    <!--[if (gt IE 9)|!(IE)]><!-->
    <script src="{{ asset('front-theme-asset/primex') }}/js/jquery.mobile.customized.min.js"></script>
    <!--<![endif]-->
    <script src="{{ asset('front-theme-asset/primex') }}/js/camera.js"></script>
    <script src="{{ asset('front-theme-asset/primex') }}/js/owl.carousel.js"></script>
    <!--[if lt IE 9]>
            ...
            <div class="row">
                <div class="grid_12">
                    <div class="brand put-left">
                        <h1>
                            <a href="index.html">
                                <img src="{{ asset('front-theme-asset/primex') }}/images/logo.png" alt="Logo"/>
                            </a>
                        </h1>
                    </div>
...
<div class="camera-wrapper">
    <div id="camera" class="camera-wrap">
        <div data-src="{{ asset('front-theme-asset/primex') }}/images/index_slide01.jpg">
            <div class="fadeIn camera_caption">
                <h2 class="text_1 color_1">Solutions that you need!</h2>
                <a class="btn_1" href="#">More info</a>
            </div>
        </div>
        <div data-src="{{ asset('front-theme-asset/primex') }}/images/index_slide02.jpg">
            <div class="fadeIn camera_caption">
                <h2 class="text_1 color_1">Lorem ipsum dolor sit!</h2>
                <a class="btn_1" href="#">More info</a>
            </div>
        </div>
        <div data-src="{{ asset('front-theme-asset/primex') }}/images/index_slide03.jpg">
            <div class="fadeIn camera_caption">
