    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="index.html" data-0="line-height:90px;"
                   data-300="line-height:50px;">{{ $settingModel->getSetting('title', $accountId) }}</a></h1>
        </div>
        ...
        <div class="row mar-bot40">
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="align-center">
                    ...
                    <h2 class="slogan">{{ $settingModel->getSetting('first_title', $accountId) }}</h2>
                    <p>{{ $settingModel->getSetting('first_description', $accountId) }}</p>
                </div>
            </div>
        </div>
    </div>
...
<script src="{{ asset('front-theme-asset/amib') }}/js/modernizr-2.6.2-respond-1.1.0.min.js"></script>
<script src="{{ asset('front-theme-asset/amib') }}/js/jquery.js"></script>
<script src="{{ asset('front-theme-asset/amib') }}/js/jquery.easing.1.3.js"></script>
<script src="{{ asset('front-theme-asset/amib') }}/js/bootstrap.min.js"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyASm3CwaK9qtcZEWYa-iQwHaGi3gcosAJc&sensor=false"></script>
<script src="{{ asset('front-theme-asset/amib') }}/js/jquery.isotope.min.js"></script>
<script src="{{ asset('front-theme-asset/amib') }}/js/jquery.nicescroll.min.js"></script>
<script src="{{ asset('front-theme-asset/amib') }}/js/fancybox/jquery.fancybox.pack.js"></script>
<script src="{{ asset('front-theme-asset/amib') }}/js/skrollr.min.js"></script>
<script src="{{ asset('front-theme-asset/amib') }}/js/jquery.scrollTo-1.4.3.1-min.js"></script>
<script src="{{ asset('front-theme-asset/amib') }}/js/jquery.localscroll-1.2.7-min.js"></script>
<script src="{{ asset('front-theme-asset/amib') }}/js/stellar.js"></script>
<script src="{{ asset('front-theme-asset/amib') }}/js/jquery.appear.js"></script>
<script src="{{ asset('front-theme-asset/amib') }}/js/validate.js"></script>
<script src="{{ asset('front-theme-asset/amib') }}/js/main.js"></script>
