...
<head>
    ...
    <link href="{{ asset('front-theme-asset/wildflat') }}/css/style.css" rel='stylesheet' type='text/css' />
...
<body>
    ...
    <div class="header" id="move-top">
        <div class="wrap">
            <div class="header-left">
                <!----start-logo---->
                <div class="logo">
                    <a href="index.html"><img src="{{ asset('front-theme-asset/wildflat') }}/images/logo.png"
                            title="wildflat" /> </a>
                </div>
                <!----//End-logo---->
            </div>
    ...
    <div class="works" id="work">
        <div class="wrap">
            ...
            <div class="gallery">
                <div class="container">
                    ...
                    <div id="portfoliolist" style="     ">
                        <div class="portfolio logo1 mix_all" data-cat="logo" style="display: inline-block; opacity: 1;">
                            <div class="portfolio-wrapper">
                                <a class="popup-with-zoom-anim zoom pink" href="#small-dialog1">
                                    <img src="{{ asset('front-theme-asset/wildflat') }}/images/p1.jpg" alt="Image 2"
                                        style="top: 0px;">
                                </a>
                            </div>
                        </div>
                        <div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
                            <div class="portfolio-wrapper">
                                <a class="popup-with-zoom-anim zoom pink" href="#small-dialog1">
                                    <img src="{{ asset('front-theme-asset/wildflat') }}/images/p2.jpg" alt="Image 2"
                                        style="top: 0px;">
                                </a>
                            </div>
                        </div>
                        <div class="portfolio web mix_all" data-cat="web" style="display: inline-block; opacity: 1;">
                            <div class="portfolio-wrapper">
                                <a class="popup-with-zoom-anim zoom pink" href="#small-dialog1">
                                    <img src="{{ asset('front-theme-asset/wildflat') }}/images/p3.jpg" alt="Image 2"
                                        style="top: 0px;">
                                </a>
                            </div>
                        </div>
                        <div class="portfolio card mix_all" data-cat="card"
                            ...
                            <div class="portfolio-wrapper">
                                <a class="popup-with-zoom-anim zoom pink" href="#small-dialog1">
                                    <img src="{{ asset('front-theme-asset/wildflat') }}/images/p4.jpg" alt="Image 2"
                                        style="top: 0px;">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
                            <div class="portfolio-wrapper">
                                <a class="popup-with-zoom-anim zoom pink" href="#small-dialog1">
                                    <img src="{{ asset('front-theme-asset/wildflat') }}/images/p5.jpg" alt="Image 2"
                                        style="top: 0px;">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="portfolio card mix_all" data-cat="card"
                            ...
                            <div class="portfolio-wrapper">
                                <a class="popup-with-zoom-anim zoom pink" href="#small-dialog1">
                                    <img src="{{ asset('front-theme-asset/wildflat') }}/images/p6.jpg" alt="Image 2"
                                        style="top: 0px;">
                                </a>
                            </div>
                        </div>
                        <div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
                            <div class="portfolio-wrapper">
                                <a class="popup-with-zoom-anim zoom pink" href="#small-dialog1">
                                    <img src="{{ asset('front-theme-asset/wildflat') }}/images/p7.jpg" alt="Image 2"
                                        style="top: 0px;">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="portfolio card mix_all" data-cat="card"
                            ...
                            <div class="portfolio-wrapper">
                                <a class="popup-with-zoom-anim zoom pink" href="#small-dialog1">
                                    <img src="{{ asset('front-theme-asset/wildflat') }}/images/p8.jpg" alt="Image 2"
                                        style="top: 0px;">
                                </a>
                            </div>
                        </div>
                ...
                <link href="{{ asset('front-theme-asset/wildflat') }}/css/magnific-popup.css" rel="stylesheet"
                    type="text/css">
                <script>
        ...
        <div class="wrap">
            ...
            <div class="about-grids">
                <div class="about-grid">
                    <h3>TEAM</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus sit amet scelerisque orci. Donec
                        molestie magna tincidunt lectus ornare, gravida molestie.</p>
                </div>
                <div class="about-grid">
                    <h3>CLIENTS</h3>
                    <p>Vivamus iaculis urna id dictum tempor. Praesent gravida ante nec imperdiet dignissim. Donec
                        lacinia eget mi eu convallis. lacinia laoreet nulla.</p>
                </div>
                <div class="about-grid">
                    <h3>WORK</h3>
                    <p>Donec suscipit dolor lectus, in eleifend nunc blandit et. Mauris quis lacus eu est fringilla
                        condimentum vitae vel purus. Nunc cursus nisi nec adipiscing ornare. </p>
                </div>
                <div class="clear"> </div>
            </div>
            <div class="clear"> </div>
            ...
            <div class="services-grids">
                <div class="services-grid">
                    ...
                    <div class="services-grid-right">
                        <h4>WEB DESIGN</h4>
                        <p>Bacon ipsum dolor sit amet shank tri-tip pig, short loin pork belly boudin ground round flank
                            sirloin bresaola filet mignon sausage beef ribs kielbasa. flow freely, we've created a
                            studio where we can not only work but also have fun and learn.</p>
                    </div>
                </div>
                <div class="services-grid">
                    <div class="services-grid-left">
                    ...
                    <div class="services-grid-right">
                        <h4>Logotypes</h4>
                        <p>Curabitur mollis dapibus felis, eget rhoncus lorem. Praesent faucibus euismod varius.
                            Maecenas luctus dui est, nec placerat purus tempus eu. Nullam id adipiscing ipsum. Integer
                            sed erat quis est commodo varius et in tellus. </p>
                    </div>
                </div>
                <div class="services-grid">
                    <div class="services-grid-left">
                    ...
                    <div class="services-grid-right">
                        <h4>UI design</h4>
                        <p>Quisque non ornare nisi. Nam vel nulla euismod ipsum euismod faucibus ac vel magna. Integer
                            hendrerit tellus eget lorem interdum ultrices. Aliquam gravida luctus lacus, in adipiscing
                            massa egestas eu. Proin porta non lectus ac pellentesque. </p>
                    </div>
                </div>
                <div class="services-grid">
                    <div class="services-grid-left">
            ...
            <ul id="flexiselDemo3">
                <li>
                    <div class="latest-news-grid">
                        ...
                        <p>Bacon ipsum dolor sit amet shank tri-tip pig, short loin pork belly boudin ground round flank
                            sirloin bresaola filet mignon sausage beef ribs kielbasa.</p>
                    </div>
                </li>
                <li>
                    <div class="latest-news-grid">
        ...
        <div class="wrap">
            <div class="contact-left">
                ...
                <form>
                    ...
                    <div class="form-right">
                        <textarea rows="2" cols="70" onfocus="if(this.value == 'Comment') this.value='';"
            ...
            <div class="contact-right">
                ...
                <div class="flicker-grids">
                    <ul>
                        <li><a href="#"><img src="{{ asset('front-theme-asset/wildflat') }}/images/f1.jpg"
                                    alt="" /></a></li>
                        <li><a href="#"><img src="{{ asset('front-theme-asset/wildflat') }}/images/f2.jpg"
                                    alt="" /></a></li>
                        <li><a href="#"><img src="{{ asset('front-theme-asset/wildflat') }}/images/f3.jpg"
                                    alt="" /></a></li>
                        <li><a href="#"><img src="{{ asset('front-theme-asset/wildflat') }}/images/f4.jpg"
                                    alt="" /></a></li>
                        <li><a href="#"><img src="{{ asset('front-theme-asset/wildflat') }}/images/f5.jpg"
                                    alt="" /></a></li>
                        <li><a href="#"><img src="{{ asset('front-theme-asset/wildflat') }}/images/f6.jpg"
                                    alt="" /></a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="copy-right">
        <div class="wrap">
            ...
            <a href="#move-top" id="toTop" style="display: block;"><span id="toTopHover" style="opacity: 1;">
                </span></a>
        </div>
    </div>
    <!----//End-copy-right---->
