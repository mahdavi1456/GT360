    ...
    <div class="card-body">
        <div class="row">
            <div class="col-12 form-group">
                <label class="form-label pull-right">عنوان</label>
                <select name="sec1_status" class="form-select pull-left" onchange="this.form.submit()">
                    <option
                        {{ $settingModel->getSetting('sec1_status', $accountId, $projectId) == 1 ? 'selected' : '' }}
                        value="1">فعال</option>
                    <option
                        {{ $settingModel->getSetting('sec1_status', $accountId, $projectId) == 0 ? 'selected' : '' }}
    ...
    <div class="card card-warning">
        <div class="card-header">
            ...
            <select name="service_status" class="form-select pull-left" onchange="this.form.submit()">
                <option
                    {{ $settingModel->getSetting('service_status', $accountId, $projectId) == 1 ? 'selected' : '' }}
                    value="1">فعال</option>
                <option
                    {{ $settingModel->getSetting('service_status', $accountId, $projectId) == 0 ? 'selected' : '' }}
                    value="0">غیرفعال</option>
            </select>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-3 form-group">
                        ...
                        <hr>
                        <label class="form-label">عنوان اول</label>
                        <input type="text" name="service_first_title" class="form-control"
                    ...
                    <div class="col-3 form-group">
                        ...
                        <input type="text" name="service_second_icon" class="form-control"
                            placeholder="آیکن دوم..."
                    ...
                    <div class="col-3 form-group">
                        ...
                        <input type="text" name="service_third_icon" class="form-control"
                            placeholder="آیکن سوم..."
    ...
    <div class="card card-warning">
        <div class="card-header">
            ...
            <select name="portfolio_status" class="form-select pull-left" onchange="this.form.submit()">
                <option
                    {{ $settingModel->getSetting('portfolio_status', $accountId, $projectId) == 1 ? 'selected' : '' }}
                    value="1">فعال</option>
                <option
                    {{ $settingModel->getSetting('portfolio_status', $accountId, $projectId) == 0 ? 'selected' : '' }}
                    value="0">غیرفعال</option>
            </select>
        </div>
    ...
    <div class="card card-warning">
        <div class="card-header">
            ...
            <select name="contact_status" class="form-select pull-left" onchange="this.form.submit()">
                <option
                    {{ $settingModel->getSetting('contact_status', $accountId, $projectId) == 1 ? 'selected' : '' }}
                    value="1">فعال</option>
                <option
                    {{ $settingModel->getSetting('contact_status', $accountId, $projectId) == 0 ? 'selected' : '' }}
                    value="0">غیرفعال</option>
            </select>
        </div>
