            ...
            <div class="mag-inner">
                <div class="col-md-8 mag-innert-right">
                    ...
                    <div class="technology">
                        ...
                        <div class="editor-pics">
                            <div class="col-md-3 item-pic">
                                <img src="{{ asset('front-theme-asset/motive/images/f2.jpg') }}" class="img-responsive"
                                    alt="" />
                        ...
                        <div class="editor-pics">
                            <div class="col-md-3 item-pic">
                                <img src="{{ asset('front-theme-asset/motive/images/f3.jp') }}" class="img-responsive"
                                    alt="" />
                        ...
                        <div class="editor-pics">
                            <div class="col-md-3 item-pic">
                                <img src="{{ asset('front-theme-asset/motive/images/f4.jpg') }}" class="img-responsive"
                                    alt="" />
                    ...
                    <div class="business-inner">
                        ...
                        <div class="col-md-6 b-text">
                            ...
                            <div class="icons"><a href="#"><i class="glyphicon glyphicon-user"></i>ادمین</a><a
                                    href="#"><i class="glyphicon glyphicon-comment"></i>2</a><a
                                    href="#"><i class="glyphicon glyphicon-thumbs-up"></i>152</a><a
                                    href="#"><i class="glyphicon glyphicon-thumbs-down"></i> 26</a></div>
                            <div class="clearfix"></div>
            ...
            <div class="col-md-4 mag-inner-left">
                    ...
                    <div id="example1" dir=ltr>
                        <div id="owl-demo" class="owl-carousel text-center">
                            ...
                            <div class="item">
                                ...
                                <img class="img-responsive lot"
                                    src="{{ asset('front-theme-asset/motive/images/p33.jpg') }}" alt="" />
                            </div>
                            <div class="item">
                ...
                <div class="edit-pics">
                    <div class="editor-pics">
                        ...
                        <div class="col-md-9 item-details">
                            <h5 class="inner two"><a href="post.blade.php">لورم ایپسوم متن ساختگی با تولید سادگی</a>
                            </h5>
                    ...
                    <div class="editor-pics">
                        <div class="col-md-3 item-pic">
                            <img src="{{ asset('front-theme-asset/motive/images/f1.jpg') }}" class="img-responsive"
                                alt="" />
        ...
        <div class="mag-bottom">
            ...
            <div class="grid">
                <div class="col-md-4 m-b">
                    ...
                    <div class="m-b-text">
                        <a href="post.blade.php" class="wd">چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان
                            که لازم
                            است</a>
                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک
                            است</p>
