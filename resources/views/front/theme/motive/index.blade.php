                ...
                <ul class="rslides callbacks callbacks1" id="slider4">
                    <li class="callbacks1_on"
                        ...
                        <div class="banner-info">
                            <h3>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک
                                است</h3>
                            <p>
            ...
            <div class="col-md-8 mag-innert-right">
                ...
                <div class="technology">
                    ...
                    <div class="col-md-6 tech-img">
                        <img src="{{ asset('front-theme-asset/motive/images/tech.jpg') }}" class="img-responsive"
                             alt=""/>
                    </div>
                ...
                <div class="gallery">
                    ...
                    <div class="gallery-images">
                        ...
                        <script type="text/javascript"
                                src="{{ asset('front-theme-asset/motive/js/jquery.flexisel.js') }}"></script>
                    </div>
                    <div class="course_demo1">
                        <ul id="flexiselDemo">
                            <li>
                    ...
                    <div class="top-inner">
                        ...
                        @if ($postModel->getPosts($accountId, $projectId, 'news'))
                            @foreach ( $postModel->getPosts($accountId, $projectId, 'news') as $new)
                                <div class="top-text">
                                    <a href="{{ route('showPost', ['slug' => $slug, 'componentName' => 'news', 'id' => $new->id]) }}">
