                            ...
                            <div class="business">
                                ...
                                <div class="business-inner">
                                    ...
                                    <div class="col-md-6 b-text">
                                        <h5><a href="post.blade.php">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از
                                                صنعت چاپ
                                            </a>
                                        </h5>
                                    ...
                                    <div class="business-bottom-content">
                                        <div class="col-md-6 business-bottom">
                                            ...
                                            <div class="col-md-9 b-bottom-text">
                                                <h5><a href="post.blade.php">لورم ایپسوم متن ساختگی با تولید سادگی </a>
                                                </h5>
                                                <h6><i class="glyphicon glyphicon-time"></i>Jun 25, 2015</h6>
                                                <div class="icons"><a href="#"><i
                                                            class="glyphicon glyphicon-user"></i>ادمین</a><a
                                                        href="#"><i
                                                            class="glyphicon glyphicon-comment"></i>2</a><a
                                                        href="#"><i
                                                            class="glyphicon glyphicon-thumbs-up"></i>152</a><a
                                                        href="#"><i class="glyphicon glyphicon-thumbs-down"></i>
                                                        26</a>
                                                </div>
                                                <div class="clearfix"></div>
                                            </div>
                        ...
                        <div class="col-md-4 mag-inner-left">
                                    ...
                                    <div id="owl-demo" class="owl-carousel text-center">
                                        <div class="item">
                                            ...
                                            <img class="img-responsive lot"
                                                src="{{ asset('front-theme-asset/motive/images/p1.jpg') }}"
                                                alt="" />
                                        </div>
                                        <div class="item">

                                            <img class="img-responsive lot"
                                                src="{{ asset('front-theme-asset/motive/images/p2.jpg') }}"
                                                alt="" />
                                        </div>
                                        <div class="item">
                            ...
                            <div class="sign_main">
                                ...
                                <div class="sign_up">
                                    ...
                                    <form>
                                        <input type="text" class="text" value="نام"
                                            onfocus="this.value = '';"
                                            onblur="if (this.value == '') {this.value = 'Name';}">
                                        <input type="text" class="text" value="آدرس ایمیل"
                                            onfocus="this.value = '';"
                                ...
                                <div class="editor-pics">
                                    ...
                                    <div class="col-md-9 item-details">
                                        ...
                                        <div class="td-post-date two"><i class="glyphicon glyphicon-time"></i>Feb 22,
                                            2015 <a href="#"><i class="glyphicon glyphicon-comment"></i>0 </a>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                    ...
                                    @if ($postModel->getPosts($accountId, $projectId, 'news'))
                                        @foreach ($postModel->getPosts($accountId, $projectId, 'news') as $new)
                                            <div class="top-text">
                                                ...
                                                <h5 class="top"><a href="post.blade.php">{{ $new->title }}</a>
                                                </h5>
                                                <div class="td-post-date two"><i
                                                        class="glyphicon glyphicon-time"></i>Feb 22,
                                                    2015
                    ...
                    <div class="mag-bottom">
                        ...
                        <div class="grid">
                            <div class="col-md-4 m-b">
                                ...
                                <div class="m-b-text">
                                    <a href="post.blade.php" class="wd">چاپگرها و متون بلکه روزنامه و مجله در ستون
                                        و
                                        سطرآنچنان که لازم
                                        است</a>
