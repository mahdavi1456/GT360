...
<link href="{{ asset('front-theme-asset/gym') }}/css/bootstrap.css" rel='stylesheet' type='text/css' />
<link href="{{ asset('front-theme-asset/gym') }}/css/style.css" rel='stylesheet' type='text/css' />
...
<script src="{{ asset('front-theme-asset/gym') }}/js/jquery.min.js"></script>
...
<!-- grid-slider -->
<script type="text/javascript" src="{{ asset('front-theme-asset/gym') }}/js/jquery.mousewheel.js"></script>
<script type="text/javascript" src="{{ asset('front-theme-asset/gym') }}/js/jquery.contentcarousel.js"></script>
<script type="text/javascript" src="{{ asset('front-theme-asset/gym') }}/js/jquery.easing.1.3.js"></script>
<!-- //grid-slider -->
</head>
<body>
 <!-- start header_top -->
    ...
    <div class="menu" id="menu">
	  <div class="container">
		 <div class="logo">
			<a href="index.html"><img src="{{ asset('front-theme-asset/gym') }}/images/logo.png" alt=""/></a>
		 </div>
		 <div class="h_menu4"><!-- start h_menu4 -->
		   <a class="toggleMenu" href="#">Menu</a>
			 <ul class="nav">
			   ...
			   <li><a href="{{ asset('front-theme-asset/gym') }}/blog.html">Blog</a></li>
			   <li><a href="{{ asset('front-theme-asset/gym') }}/pricing.html">Pricing</a></li>
			   <li><a href="{{ asset('front-theme-asset/gym') }}/contact.html">Contact</a></li>
			 </ul>
			  <script type="text/javascript" src="{{ asset('front-theme-asset/gym') }}/js/nav.js"></script>
		  </div><!-- end h_menu4 -->
		 <div class="clear"></div>
	  </div>
	</div>
	<!-- end menu -->
	 <div class="main">
	 	 <div class="container">
			...
			<div class="row content-top">
				 <div class="col-md-5">
				  <img src="{{ asset('front-theme-asset/gym') }}/images/pic.png" class="img-responsive" alt=""/>
			     </div>
		      ...
		      <!-- start content-middle -->
	 	    	<div class="col-md-4"><a href="pricing.html">
					 ...
					 <div class="view view-fifth">
				  	   <img src="{{ asset('front-theme-asset/gym') }}/images/pic3.jpg" class="img-responsive" alt=""/>
					      <div class="mask">
				 ...
				 <div class="col-md-4"><a href="pricing.html">
					 ...
					 <div class="view view-fifth">
				  	   <img src="{{ asset('front-theme-asset/gym') }}/images/pic2.jpg" class="img-responsive"  alt=""/>
					      <div class="mask">
	                       	<div class="info">Read More</div>
			              </div>
	                  </div>
				 ...
				 <div class="col-md-4"><a href="pricing.html">
					 ...
					 <div class="view view-fifth">
				  	   <img src="{{ asset('front-theme-asset/gym') }}/images/pic1.jpg" class="img-responsive" alt=""/>
					      <div class="mask">
	                       	<div class="info">Read More</div>
			              </div>
	                  </div>
			  ...
			  <div class="col-md-4">
		        <h3 class="m_2">Our Trainers</h3>
		         <div class="course_demo">
		          <ul id="flexiselDemo3">
					<li><img src="{{ asset('front-theme-asset/gym') }}/images/pic4.jpg" /><div class="desc">
					...
					<li><img src="{{ asset('front-theme-asset/gym') }}/images/pic5.jpg" /><div class="desc">
		...
		<script type="text/javascript" src="{{ asset('front-theme-asset/gym') }}/js/jquery.flexisel.js"></script>
	  </div>
     </div>
     <div class="col-md-4">
     	 ...
     	 <div class="events">
     	 	<div class="event-top">
	     	 	<ul class="event1">
	     	 		<h4>26 April, 2014</h4>
	     	 		<img src="{{ asset('front-theme-asset/gym') }}/images/pic.jpg" alt=""/>
	     	 	</ul>
     ...
     <div class="col-md-4">
     	 ...
     	 <div class="blog_events">
     	 	<ul class="tab-left1">
				<span class="tab1-img"><img src="{{ asset('front-theme-asset/gym') }}/images/pic7.jpg" alt=""></span>
				<div class="tab-text1">
			...
			<ul class="tab-left1">
				<span class="tab1-img"><img src="{{ asset('front-theme-asset/gym') }}/images/pic6.jpg" alt=""></span>
				<div class="tab-text1">
			...
			<ul class="tab-last1">
				<span class="tab1-img"><img src="{{ asset('front-theme-asset/gym') }}/images/pic8.jpg" alt=""></span>
				<div class="tab-text1">
      ...
      <div class="row about">
		 <div class="col-md-8">
		   ...
		   <div class="col-md-4">
			  ...
			  <ul class="partner">
			  	<li><img src="{{ asset('front-theme-asset/gym') }}/images/p6.png" alt=""/></li>
			  	<li><img src="{{ asset('front-theme-asset/gym') }}/images/p5.png" alt=""/></li>
			  	<li><img src="{{ asset('front-theme-asset/gym') }}/images/p4.png" alt=""/></li>
			  	<li><img src="{{ asset('front-theme-asset/gym') }}/images/p3.png" alt=""/></li>
			  	<li><img src="{{ asset('front-theme-asset/gym') }}/images/p2.png" alt=""/></li>
			  	<li><img src="{{ asset('front-theme-asset/gym') }}/images/p1.png" alt=""/></li>
			  	 <div class="clear"></div>
			  </ul>
		   </div>
	       <div class="clear"></div>
		 ...
		 <div class="footer-bottom">
		   <div class="container">
		 	 <div class="row section group">
				...
				<div class="col-md-4">
					<div class="f-logo">
						<img src="{{ asset('front-theme-asset/gym') }}/images/logo.png" alt=""/>
					</div>
