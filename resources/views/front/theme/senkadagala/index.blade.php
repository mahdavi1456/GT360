...
<body>
	...
	<div class="content"  id="home">
		<div class="section section1">
			<div class="container">
				<div class="row">
					<div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 col-xs-offset-3 col-sm-offset-4 col-md-offset-5 main-logo">{{ $settingModel->getSetting('first_cover', $accountId) }}</div>
				</div>
				<div class="row">
