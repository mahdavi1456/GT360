                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 intro-text">
                            ...
                            <p>
                                Senkadagala is a small, responsive, Twitter Bootstrap based HTML5 web layout. It uses
                                one page architecture and displays all the information on the same page. Name for this
                                theme is inspired by the city in central Sri Lanka - Kandy.
                            </p>

                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut id ultricies felis. Fusce
                                sed nisi velit. Quisque cursus pharetra diam, non congue ligula sodales at. Phasellus
                                sodales sem sagittis arcu vulputate dictum. Vestibulum faucibus malesuada risus.
                            </p>
                        </div>
                    </div>
                    <div class="row team">
                        <div class="col-md-4">
                            <img src="{{ asset('front-theme-asset/senkadagala') }}/img/team/user1.png"
                                class="img-responsive">
                            <h3 class="team-name">Member One</h3>
                            <h4 class="team-subtitle">Awesome Designation</h4>
                            <p class="team-details">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam aliquet dolor nec diam
                                pharetra, eu sodales massa euismod. Maecenas ut tellus sit amet lectus molestie dapibus.
                                Quisque fermentum rutrum felis, nec hendrerit diam mollis vitae. Integer sodales varius
                                odio, vel pharetra ante rhoncus vel. Phasellus quis urna rutrum, molestie purus.
                            </p>
                        </div>
                        <div class="col-md-4">
                            <img src="{{ asset('front-theme-asset/senkadagala') }}/img/team/user2.png"
                                class="img-responsive">
                        ...
                        <div class="col-md-4">
                            <img src="{{ asset('front-theme-asset/senkadagala') }}/img/team/user3.png"
                                class="img-responsive">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 col-md-3 service-item">
                            <img src="{{ asset('front-theme-asset/senkadagala') }}/img/web-design.png"
                                title="Web design" class="img-responsive">
                            <h3>Web Designing</h3>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam aliquet dolor nec diam
                                pharetra, eu sodales massa euismod.
                            </p>
                        </div>
                        <div class="col-sm-6 col-md-3 service-item">
                            <img src="{{ asset('front-theme-asset/senkadagala') }}/img/web-dev.png"
                                title="Web development" class="img-responsive">
                        ...
                        <div class="col-sm-6 col-md-3 service-item">
                            <img src="{{ asset('front-theme-asset/senkadagala') }}/img/print.png"
                                title="Print media design" class="img-responsive">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <div class="portfolio-item-description">
                                                    ...
                                                    <p>Website design and the concept development is done by PixelMock
                                                        and it was a pleasure experience to work with Sankalana holdings
                                                        to deliver something awesome</p>
                                                    <p>Concept design was developed using Adobe Photoshop and later
                                                        customized using HTML, CSS and jQuery. </p>
                                    ...
                                    <div class="modal-content">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <div class="portfolio-item-description">
                                                    ...
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi
                                                        vitae porttitor dolor, sit amet consectetur lectus. Nunc vitae
                                                        viverra enim, non blandit tortor. Suspendisse convallis. </p>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi
                                                        vitae porttitor dolor, sit amet consectetur lectus. Nunc vitae
                                                        viverra enim, non blandit tortor. Suspendisse convallis. </p>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi
                                            ...
                                            <div class="col-xs-12">
                                                <div class='popup-image-container'>
                                                    <img src="{{ asset('front-theme-asset/senkadagala') }}/img/portfolio/print/blackwelling/1.jpg"
                                                        title="Blackwelling Recruitment"
                                                        class="portfolio-big img-responsive">
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-5 contact-description">
                            <p>We are bunch of open minded people. So, we are really keen to know what you're thinking
                                of our work.</p>
                            <p>Furthermore, if you're having some sort of work that we can assist you, a design project,
                                web site, branding project... anything that matching our skill profile, send us a mail
                                using below form. We will get back to you soon!</p>
                        ...
                        <div class="col-md-offset-1 col-md-6">
                            ...
                            <form id="contact-form">
                                ...
                                <div class="form-group">
                                    <label for="phone">Phone Number (Optional) <small>Eg :
                                            +94771234569</small></label>
