        ...
        <div class="row">
            <div class="col-6 form-group">
                ...
                <input type="text" name="title" class="form-control" placeholder="عنوان..."
                       value="{{ $settingModel->getSetting('title', $account->id,2) }}">
            </div>
            <div class="col-6 form-group">
                <label class="form-label">توضیحات</label>
                <input type="text" name="description" class="form-control" placeholder="توضیحات..."
                       value="{{ $settingModel->getSetting('description', $account->id,2) }}">
            </div>
            <div class="col-6 form-group">
        ...
        <div class="row">
            <div class="col-4 form-group">
                ...
                <input type="text" name="first_title" class="form-control" placeholder="عنوان اول..."
                       value="{{ $settingModel->getSetting('first_title', $account->id,2) }}">
            </div>
            <div class="col-4 form-group">
                ...
                <input type="text" name="first_subtitle" class="form-control" placeholder="زیر عنوان اول..."
                       value="{{ $settingModel->getSetting('first_subtitle', $account->id,2) }}">
            </div>
            <div class="col-4 form-group">
                <label class="form-label">متن اول</label>
                <input type="text" name="first_text" class="form-control" placeholder="متن اول..."
                       value="{{ $settingModel->getSetting('first_text', $account->id,2) }}">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-12 form-group">
                ...
                <textarea name="google_map" class="form-control ltr"
                          placeholder="نقشه گوگل...">{{ $settingModel->getSetting('google_map', $account->id,2) }}</textarea>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-6 form-group">
                ...
                <input type="text" name="service_third_icon" class="form-control" placeholder="آیکن سوم..."
                       value="{{ $settingModel->getSetting('service_third_icon', $account->id,2) }}">
                <hr>
                ...
                <input type="text" name="service_third_title" class="form-control" placeholder="عنوان چهارم..."
                       value="{{ $settingModel->getSetting('service_third_title', $account->id,2) }}">
            </div>
            <div class="col-6 form-group">
                ...
                <input type="text" name="service_fourth_icon" class="form-control" placeholder="آیکن چهارم..."
                       value="{{ $settingModel->getSetting('service_fourth_icon', $account->id,2) }}">
                <hr>
                ...
                <input type="text" name="service_fourth_title" class="form-control" placeholder="عنوان چهارم..."
                       value="{{ $settingModel->getSetting('service_fourth_title', $account->id,2) }}">
            </div>
        </div>
    </div>
</div>
