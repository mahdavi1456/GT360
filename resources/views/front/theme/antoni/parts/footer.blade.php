            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <div class="copyright_area">
                        <p>ارائه شده در وب‌سایت <a href="https://market.radib.com/store/hesdesign/" target="_blank">=> فایل مارکت رادیب <= </a></p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                ...
                <div class="box-content newleter-content">
                    ...
                    <div id="frm_subscribe">
                        <form name="subscribe" id="subscribe_popup">
                            <input type="text" value="" name="subscribe_pemail" id="subscribe_pemail" placeholder="... ایمیل خود را وارد کنید" dir="ltr">
