...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link href="{{ asset('front-theme-asset/shutter') }}/css/bootstrap.min.css" rel="stylesheet">
    <link href="http://netdna.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('front-theme-asset/shutter') }}/css/flexslider.css" type="text/css">
    <link href="{{ asset('front-theme-asset/shutter') }}/css/styles.css?v=1.6" rel="stylesheet">
    <link href="{{ asset('front-theme-asset/shutter') }}/css/queries.css?v=1.6" rel="stylesheet">
    <link href="{{ asset('front-theme-asset/shutter') }}/css/jquery.fancybox.css" rel="stylesheet">
    <!-- Fonts -->
    ...
    <body>
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              <div id="firstSlider">
                <ul class="slides">
                  <li>
                    <div class="avatar"><img src="{{ asset('front-theme-asset/shutter') }}/img/av-blaz.png" alt="Blaz Robar"></div>
                    <h1>I couldnt possibly use my own eyes to look at the stars, thansk Starnught App.</h1>
                  </li>
                  <li>
                    <div class="avatar"><img src="{{ asset('front-theme-asset/shutter') }}/img/av-pete.png" alt="Pete Finlan"></div>
                    <h1>Staring at the stars has given me feels like never before.</h1>
                  </li>
                  <li>
                    <div class="avatar"><img src="{{ asset('front-theme-asset/shutter') }}/img/av-doge.png" alt="Doge Finbar"></div>
      ...
      <script src="{{ asset('front-theme-asset/shutter') }}/js/jquery.fancybox.pack.js"></script>
      <!-- Include all compiled plugins (below), or include individual files as needed -->
      <script src="{{ asset('front-theme-asset/shutter') }}/js/bootstrap.min.js"></script>
      <script src="{{ asset('front-theme-asset/shutter') }}/js/scripts.js?v=1.7"></script>
      <script src="{{ asset('front-theme-asset/shutter') }}/js/jquery.flexslider.js"></script>
      <script src="{{ asset('front-theme-asset/shutter') }}/js/jquery.smooth-scroll.js"></script>
      <script src="{{ asset('front-theme-asset/shutter') }}/js/modernizr.js"></script>
      <script src="{{ asset('front-theme-asset/shutter') }}/js/waypoints.min.js"></script>
    </body>
  </html>
