                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control"
                                                    value="{{ old('name') ?? $nav?->name }}" placeholder="نام..." required
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="label" class="form-control"
                                                    value="{{ old('label') ?? $nav?->label }}" placeholder="برچسب..." required
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select name="status" class="form-control">
                                                    ...
                                                    <option value="غیرفعال" @selected($nav?->status == 'غیرفعال')>غیرفعال</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group abstract">
                                                <label>توضیحات</label>
                                                <textarea name="desc" class="form-control Reditor1" placeholder="توضیحات ...">{{ old('desc') ?? $nav?->desc }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
