                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <select name="year" id="year" class="form-control">
                                                <option {{ $currentYear == '1399' ? 'selected' : '' }} value="1399">1399
                                                </option>
                                                <option {{ $currentYear == '1400' ? 'selected' : '' }} value="1400">1400
                                                </option>
                                                <option {{ $currentYear == '1401' ? 'selected' : '' }} value="1401">1401
                                                </option>
                                                <option {{ $currentYear == '1402' ? 'selected' : '' }} value="1402">1402
                                                </option>
                                                <option {{ $currentYear == '1403' ? 'selected' : '' }} value="1403">1403
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 form-group">
                                            ...
                                            <select name="month" id="month" class="form-control">
                                                <option {{ $currentMonth == '1' ? 'selected' : '' }} value="1">فروردین
                                                </option>
                                                <option {{ $currentMonth == '2' ? 'selected' : '' }} value="2">اردیبهشت
                                                </option>
                                                <option {{ $currentMonth == '3' ? 'selected' : '' }} value="3">خرداد
                                                </option>
                                                <option {{ $currentMonth == '4' ? 'selected' : '' }} value="4">تیر
                                                </option>
                                                <option {{ $currentMonth == '5' ? 'selected' : '' }} value="5">مرداد
                                                </option>
                                                <option {{ $currentMonth == '6' ? 'selected' : '' }} value="6">شهریور
                                                </option>
                                                <option {{ $currentMonth == '7' ? 'selected' : '' }} value="7">مهر
                                                </option>
                                                <option {{ $currentMonth == '8' ? 'selected' : '' }} value="8">آبان
                                                </option>
                                                <option {{ $currentMonth == '9' ? 'selected' : '' }} value="9">آذر
                                                </option>
                                                <option {{ $currentMonth == '10' ? 'selected' : '' }} value="10">دی
                                                </option>
                                                <option {{ $currentMonth == '11' ? 'selected' : '' }} value="11">بهمن
                                                </option>
                                                <option {{ $currentMonth == '12' ? 'selected' : '' }} value="12">اسفند
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <button type="submit" name="filter"
                                                class="btn btn-success w-100">جستجو</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
