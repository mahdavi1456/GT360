                        ...
                        <div class="card">
                            <div class="card-body">
                                @if ($errors->any())
                                    ...
                                    @endif
                                @endif
                                <form method="POST" action="{{ route('payments_type.update', $paymentType->id) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" id="name"
                                                    placeholder="نام..." value="{{ old('name') ?? $paymentType->name }}" required
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="icon" class="form-control" id="icon"
                                                    placeholder="آیکون..." value="{{ old('icon') ?? $paymentType->icon }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select name="display_order" id="display_order" class="form-control"
                                                    ...
                                                    @for ($i = 1; $i <= 10; $i++)
                                                        <option value="{{ $i }}" {{ $i == $paymentType->display_order ? 'selected' : '' }}>{{ $i }}</option>
                                                    @endfor
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select name="status" class="form-control" id="status" required
                                                    ...
                                                    oninput="this.setCustomValidity('')">
                                                    <option value="">انتخاب کنید...</option>
                                                    <option value="active" {{ $paymentType->status == 'active' ? 'selected' : '' }}>فعال</option>
                                                    <option value="inactive" {{ $paymentType->status == 'inactive' ? 'selected' : '' }}>غیرفعال</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label>توضیحات</label>
                                                <textarea name="description" class="form-control" id="description" placeholder="توضیحات...">{{ old('description') ?? $paymentType->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
