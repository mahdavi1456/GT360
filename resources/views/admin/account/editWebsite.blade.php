                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                @endif
                                <form action="{{ route('accountSite.update',$account->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="domain" class="form-control nonPersianletters"
                                                    value="{{ old('domain')??$account->domain }}" placeholder="دامین..." required
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="slug"
                                                    ...
                                                    placeholder="نام سایت..." value="{{ old('slug') ?? $account->slug }}"
