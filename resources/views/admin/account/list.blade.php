                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                @foreach ($accounts as $account)
                                                    <tr>
                                                        <td class="w-auto text-center">{{ fa_number($loop->index + 1) }}
                                                        </td>
                                                        ...
                                                        <td class="w-auto text-center">{{ fa_number($account->mobile) }}
                                                        </td>
                                                        <td class="w-auto text-center">
                                                            ...
                                                            @elseif ($account->account_status == 'waiting')
                                                                <span class="badge bg-warning"
                                                                    style="font-size: 17px;color: #FFF !important;">در
                                                                    انتظار تایید</span>
                                                        ...
                                                        <td class="d-flex">
                                                            ...
                                                            <form action="{{ route('account.destroy', $account->id) }}"
                                                                ...
                                                                <button type="submit" class="btn btn-danger m-1"
                                                                    id="confirmdelete{{ $account->id }}">حذف</button>
                                                            </form>
                                                            @if ($account->account_status == 'active')
