                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control persianletters" id="name" placeholder="نام..." value="{{ old('name') ?? $account->name }}" required
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="family" class="form-control persianletters" id="family" placeholder="نام خانوادگی..." value="{{ old('family') ?? $account->family }}" required
